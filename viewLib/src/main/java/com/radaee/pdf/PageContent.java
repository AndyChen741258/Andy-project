...
public class PageContent
{
	 ...
	 */
    final public void GSSet( Page.ResGState gs )
	{
		if( gs != null )
			gsSet(hand, gs.hand);
	}
	 ...
	 */
    final public void DrawImage(Page.ResImage image)
	{
	 ...
	 */
    final public void TextSetFont(Page.ResFont font, float size)
	{
	 ...
	 * @return
	 */
    final public float[] TextGetSize(Page.ResFont font, String text, float width, float height, float char_space, float word_space )
	{
