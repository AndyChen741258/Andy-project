...
public class Global
{
    public static void Init(Activity act)
    {
        ...
        Init( act, 2, "naer", "chenghe0128@gmail.com",
                "N1K9KO-QJS4RH-LDBHAO-RCKMFY-51NKO6-K0WZ9D" );
    }
	/**
	 ...
	 * width for ink lines.
	 */
	public static float inkWidth = 5;
	/**
	...
	public static boolean Init(Activity act, int license_type, String company_name, String mail, String serial)
	{
        ...
        load_std_font( res, com.radaee.viewlib.R.raw.rdf008, 8, new File(files, "rdf008") );
        load_std_font( res, com.radaee.viewlib.R.raw.rdf013, 13, new File(files, "rdf013") );
		load_cmyk_icc( res, com.radaee.viewlib.R.raw.cmyk_rgb, new File(files, "cmyk_rgb") );
		load_cmaps( res, com.radaee.viewlib.R.raw.cmaps, new File(files, "cmaps"), com.radaee.viewlib.R.raw.umaps, new File(files, "umaps") );
        ...
        load_truetype_font( res, com.radaee.viewlib.R.raw.arimo, new File(files, "arimo.ttf") );
        load_truetype_font( res, com.radaee.viewlib.R.raw.arimob, new File(files, "arimob.ttf") );
        load_truetype_font( res, com.radaee.viewlib.R.raw.arimoi, new File(files, "arimoi.ttf") );
        load_truetype_font( res, com.radaee.viewlib.R.raw.arimobi, new File(files, "arimobi.ttf") );
        load_truetype_font( res, com.radaee.viewlib.R.raw.tinos, new File(files, "tinos.ttf") );
        load_truetype_font( res, com.radaee.viewlib.R.raw.tinosb, new File(files, "tinosb.ttf") );
        load_truetype_font( res, com.radaee.viewlib.R.raw.tinosi, new File(files, "tinosi.ttf") );
        load_truetype_font( res, com.radaee.viewlib.R.raw.tinosbi, new File(files, "tinosbi.ttf") );
        load_truetype_font( res, com.radaee.viewlib.R.raw.cousine, new File(files, "cousine.ttf") );
        load_truetype_font( res, com.radaee.viewlib.R.raw.cousineb, new File(files, "cousineb.ttf") );
        load_truetype_font( res, com.radaee.viewlib.R.raw.cousinei, new File(files, "cousinei.ttf") );
        load_truetype_font( res, com.radaee.viewlib.R.raw.cousinebi, new File(files, "cousinebi.ttf") );
		fontfileListEnd();
