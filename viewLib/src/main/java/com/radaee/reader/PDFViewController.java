...
public class PDFViewController implements OnClickListener, SeekBar.OnSeekBarChangeListener
{
	...
	public PDFViewController(RelativeLayout parent, PDFLayoutView view)
	{
		m_parent = parent;
		m_view = view;
		m_bar_act = new PDFTopBar(m_parent, com.radaee.viewlib.R.layout.bar_act);
		m_bar_cmd = new PDFTopBar(m_parent, com.radaee.viewlib.R.layout.bar_cmd);
		m_bar_find = new PDFTopBar(m_parent, com.radaee.viewlib.R.layout.bar_find);
		m_bar_annot = new PDFTopBar(m_parent, com.radaee.viewlib.R.layout.bar_annot);
		m_bar_seek = new PDFBotBar(m_parent, com.radaee.viewlib.R.layout.bar_seek);
		m_menu_view = new PDFMenu(m_parent, com.radaee.viewlib.R.layout.pop_view);
		RelativeLayout layout = (RelativeLayout)m_bar_cmd.BarGetView();
		btn_view = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_view);
		btn_find = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_find);
		btn_annot = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_annot);
		btn_select = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_select);
		btn_drive = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_drive);
		layout = (RelativeLayout)m_bar_find.BarGetView();
		btn_find_back = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_back);
		btn_find_prev = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_left);
		btn_find_next = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_right);
		edit_find = (EditText)layout.findViewById(com.radaee.viewlib.R.id.txt_find);
		layout = (RelativeLayout)m_bar_act.BarGetView();
		btn_act_back = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_back);
		btn_act_edit = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_edit);
		btn_act_perform = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_perform);
		btn_act_remove = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_remove);
		layout = (RelativeLayout)m_bar_annot.BarGetView();
		btn_annot_back = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_back);
		btn_annot_ink = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_annot_ink);
		btn_annot_line = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_annot_line);
		btn_annot_rect = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_annot_rect);
		btn_annot_oval = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_annot_oval);
		btn_annot_stamp = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_annot_stamp);
		btn_annot_note = (ImageView)layout.findViewById(com.radaee.viewlib.R.id.btn_annot_note);
		layout = (RelativeLayout)m_bar_seek.BarGetView();
		seek_page = (SeekBar)layout.findViewById(com.radaee.viewlib.R.id.seek_page);
		lab_page = (TextView)layout.findViewById(com.radaee.viewlib.R.id.lab_page);
		lab_page.setTextColor(-1);
		LinearLayout layout1 = (LinearLayout)m_menu_view.MenuGetView();
		view_vert = layout1.findViewById(com.radaee.viewlib.R.id.view_vert);
		view_single = layout1.findViewById(com.radaee.viewlib.R.id.view_single);
		view_dual = layout1.findViewById(com.radaee.viewlib.R.id.view_dual);
	...
	public void OnBlankTapped()
	{
		...
		case BAR_ANNOT:
			m_bar_annot.BarHide();
			SetBtnChecked(btn_annot_note, false);//預設按鈕清空
	...
	public void onProgressChanged(SeekBar arg0, int arg1, boolean arg2)
	{
		...
		PDFLayoutView.pageNumber=lab_page.getText().toString();
	}
	@Override
	...
	public void onClick(View arg0)
	{
		...
		else if( arg0 == view_vert )//直向
		{
			PDFLayoutView.View_mode="直向";
			m_view.PDFSetView(0);
			m_menu_view.MenuDismiss();
		}
		else if( arg0 == view_single )//單頁
		{
			PDFLayoutView.View_mode="單頁";
			m_view.PDFSetView(3);
			m_menu_view.MenuDismiss();
		}
		else if( arg0 == view_dual )//雙頁
		{
			PDFLayoutView.View_mode="雙頁";
			m_view.PDFSetView(4);
			m_menu_view.MenuDismiss();
		}
	}
