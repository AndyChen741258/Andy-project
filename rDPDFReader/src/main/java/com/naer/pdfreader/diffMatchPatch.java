...
public class diffMatchPatch {
    ...
    for (Diff aDiff : diffs) {
      ...
      switch (aDiff.operation) {
        case INSERT:
          ...
          break;
        case DELETE:
          html.append("<del>").append("<font color=\"#d46043\">").append(text).append("</font>").append("</del>");
          break;
        case EQUAL:
  ...
  protected LinesToCharsResult diff_linesToWords(String text1, String text2) {
    ...
    // Allocate 2/3rds of the space for text1, the rest for text2.
    String chars1 = diff_linesToWordMunge(text1, lineArray, lineHash, 40000);
    String chars2 = diff_linesToWordMunge(text2, lineArray, lineHash, 65535);
    return new LinesToCharsResult(chars1, chars2, lineArray);
  }

  private String diff_linesToWordMunge(String text, List<String> lineArray, Map<String, Integer> lineHash, int maxLines) {
    int lineStart = 0;
    int lineEnd = -1;
    String line;
    StringBuilder chars = new StringBuilder();
